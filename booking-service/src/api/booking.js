...
module.exports = ({repo}, app) => {
    app.post('/booking', (req, res, next) => {
        ...
        const notificationSerrvice = req.container.resolve('notificationService');
        ...
        Promise.all([
            ...
            const payment = {
                ...
                description: `
                    Titcket(s) for movie ${booking.movie},
            ...
            const payload = Object.assign({}, { user: {name: user.name + user.lastName, email: user.email} });
            notificationSerrvice(payload);
    ...
    app.get('/booking/verify/:orderId', (req, res, next) => {
        repo.getOrderById(req.params.orderId).then(order => {
